...
enum _FLReorderableListViewType {
  normal,
  builder,
}

class FLReorderableListView extends StatefulWidget {
  FLReorderableListView({
    ...
    this.onRefresh,
  })  : _listViewType = _FLReorderableListViewType.normal,
        itemBuilder = ((BuildContext context, int index) => children[index]),
        itemCount = children.length;

  const FLReorderableListView.builder({
    ...
    this.onReachedEndPercentage = 0.7,
    this.onRefresh,
  }) : _listViewType = _FLReorderableListViewType.builder;

  final _FLReorderableListViewType _listViewType;
  ...
  @override
  State<FLReorderableListView> createState() => _FLReorderableListViewState();
}

class _FLReorderableListViewState extends State<FLReorderableListView> {
  ...
  Widget build(BuildContext context) {
    return switch (widget._listViewType) {
      _FLReorderableListViewType.normal => _reorderableListView,
      _FLReorderableListViewType.builder => _reorderableListViewBuilder,
    };
  }
...
class _CustomScrollViewState extends State<_CustomScrollView> {
  ...
  @override
  Widget build(BuildContext context) {
    final state = context.findAncestorStateOfType<_FLReorderableListViewState>();
