...
abstract interface class IFLSqfliteManager {
  Future<void> openDB();
...
abstract class FLSqfliteManager implements IFLSqfliteManager {
  FLSqfliteManager({
  ...
  @override
  @nonVirtual
  Future<FLBatch> batch() async {
    final db = await _initDB();
    return FLBatch(db.batch());
  }
