...
enum FLPermissionStatus {
  ...
  static FLPermissionStatus fromPermissionStatus(PermissionStatus status) {
    return switch (status) {
      PermissionStatus.granted || PermissionStatus.limited => FLPermissionStatus.granted,
      PermissionStatus.denied => FLPermissionStatus.neverPrompted,
      PermissionStatus.permanentlyDenied => FLPermissionStatus.permanentlyDenied,
