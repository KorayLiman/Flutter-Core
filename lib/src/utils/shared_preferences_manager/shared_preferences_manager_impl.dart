...
abstract interface class IFLSharedPreferencesManager {
...
abstract class FLSharedPreferencesManager implements IFLSharedPreferencesManager {
  FLSharedPreferencesManager({
    this.encryptionKey,
    this.encryptionIv,
  }) {
